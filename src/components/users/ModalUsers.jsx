  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 overflow-y-auto">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl my-4">
        <div className="flex items-center justify-between border-b border-gray-200 p-4 sticky top-0 bg-white z-10 rounded-t-2xl">
          <h2 className="text-base font-bold text-gray-900">{user ? "Editar Usuario" : "Crear Nuevo Usuario"}</h2>
        ...
        <div className="max-h-[calc(100vh-8rem)] overflow-y-auto">
          <form onSubmit={handleSubmit} className="space-y-6 p-6">
            ...
            <div className="flex justify-end space-x-3 sticky bottom-0 pt-4 bg-white">
              <button
                type="button"
                onClick={onClose}
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? <Loading /> : user ? "Actualizar" : "Guardar"}
              </button>
            </div>
          </form>
        </div>
